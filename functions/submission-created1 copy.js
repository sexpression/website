...
exports.handler = async function(event, context, callback) {
    ...
    // send email to member - Directus /////////////////
    // send all data

    // send email to sender - user /////////////////
    // send Directus response

    // if request-a-session or join-a-branch ////////////////////////////////////////

    // send email to member - Directus /////////////////
    // send all data

    // send email to branch - Directus /////////////////
    // send all data
    ...
    // SENDER
    let senderEmail = payload.email; // form
    let senderName = payload.fullname; // form
    let senderPronouns = payload.genderpronouns; // form
    let recipientEmail = payload.email; // directus
